...
def osw_snapshot(xml_path_file,img_dir,ip):
    ...
    driver = webdriver.Chrome(chrome_options=chrome_options, executable_path="E:\\tools\\lenovo.exe")
...
def gen_osw_img(ip):
    osw_path = base_dir + '\\osw'
    img_dir = 'E:\\project\\DbManage\\apps\\static\\osw'
...
def gen_sqlserver_img():
    img_path = "E:\\project\\DbManage\\apps\\static\\sqlserver"
